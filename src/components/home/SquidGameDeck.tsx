...
const THEME_MAP: Record<CardTheme, { cardBg: string; tagBg: string; tagText: string }> = {
  "Maroon Red":  { cardBg: "#5A1422", tagBg: "#F5D0DC", tagText: "#5A1422" },
  "Pink":        { cardBg: "#B53D6A", tagBg: "#FDE8F0", tagText: "#8A1F45" },
  "Orange":      { cardBg: "#B54A10", tagBg: "#FDEAD0", tagText: "#7A2E08" },
  "Blue":        { cardBg: "#1640B0", tagBg: "#D8E8FF", tagText: "#0A2880" },
  "Light Green": { cardBg: "#5A9A2A", tagBg: "#E8F8D0", tagText: "#2A5A0A" },
  "Green":       { cardBg: "#1A7040", tagBg: "#D0F0E0", tagText: "#0A4020" },
};
...
export default function FlickSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full min-h-[100vh] flex flex-col items-center justify-center bg-black text-white font-sans overflow-hidden py-49"
    >
      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-6 md:px-10 flex flex-col items-center">
        ...
        <div
          ...
          style={{ top: "-10%", left: "4%", width: "clamp(52px, 7vw, 90px)" }}
          aria-hidden
        >
        ...
        <div
          ...
          style={{
            ...
            marginBottom:  "4rem",
            marginTop:     "2rem",
            overflow:      "visible",   // cards & stickers fan beyond this box
          }}
        >
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    cursor:       i === activeIdx ? "grab" : "pointer",
                  }}
                ...
                >
                    ...
                    {c.videoId && i === activeIdx && (
                      <div className="absolute bottom-16 left-1/2 -translate-x-1/2 text-white/40 pointer-events-none">
                        <svg
                          viewBox="0 0 100 100"
                          className="w-8 h-8"
                          style={{ display: "none" }} // hidden by default; show in loading state if needed
                        >
                          <path
                            fill="currentColor"
                  ...
                  <div
                    className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 px-4 py-1.5 rounded-[12px] text-[12px] font-bold tracking-wide shadow-md whitespace-nowrap z-20"
          ...
          <div
            ...
            className="absolute"
            style={{
              inset:      "-40px -80px", // extends slightly beyond card fan
              zIndex:     10,
              cursor:     "grab",
              touchAction: "pan-y",
            }}
        ...
        <div
          ref={infoWrapRef}
          className="flex flex-col items-center justify-center text-center gap-4 relative z-20"
          style={{ maxWidth: "clamp(260px, 80vw, 680px)", margin: "0 auto" }}
        >
          {/* Project title */}
          <h3
          ...
          >
            ...
            <svg
              ...
              fill="none"
              aria-hidden
              className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-full pointer-events-none"
              style={{ overflow: "visible" }}
            >
              <path
                ref={drawPath1Ref}
